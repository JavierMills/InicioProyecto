...
export class TableComponent implements OnInit, OnDestroy {
  ...
  data=[
    ...
    {
    "id": 2,
    "status":"ProcesoPendienteAsesorC",
    "name": "Ervin Howell",
    "username": "Antonette",
    ...
    {
    "id": 4,
    "status":"ProcesoPendienteContraloria",
